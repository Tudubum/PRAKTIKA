const formSec = document.querySelector('#forma'); // sukuriamas formSec kintamasis, kuris priskiriamas HTML'e esančiam elementui, kuris turi ID 'forma'
...
let saskaitosSukurimas = (prekes) => { // saskaitosSukurimas funkcijos prilyginimas ir parametras, kuriame yra prekės, kurias reikia sukelti į sąskaitą
  ...
  text = document.createTextNode("Liux kebabai"); // sukuriamas tekstinis elementas su tekstu "Įmonės pav"
  ...
  text = document.createTextNode(`Bendra suma: ${bendraKaina.toFixed(2)}€`); // sukuriamas tekstinis elementas, kuriam suteikiamas tekstas 'Bendra kaina: ' ir bendra viso užsakymo kaina
  ...
  text = document.createTextNode('Ačiū, kad perkate!'); // sukuriamas tekstinis elementas su tekstu 'Padėkojimas'
